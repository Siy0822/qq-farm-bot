      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          <div class="flex items-center gap-2 font-bold">
            ...
            <span v-if="Number(friend?.dogId) > 0" class="rounded bg-red-100 px-1.5 py-0.5 text-xs text-red-600 dark:bg-red-900/30 dark:text-red-400">{{ friend?.dogName || '护主犬' }}</span>
          </div>
